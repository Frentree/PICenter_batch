...
public class pi_topcompVo {
	...
	public void setPersol(PersonalVo v) {
		...
		this.meritz_acc=v.getMeritz_acc();
	...
	public long getMeritz_acc_pre() {
		return meritz_acc_pre;
	}

	public void setMeritz_acc_pre(long meritz_acc_pre) {
		this.meritz_acc_pre = meritz_acc_pre;
	}
